...
public class ArrayMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("arr1:"+arr1); //[I@515f550a
		// [ : 배열 차원
		// I : int
		// @ : 구분
		...
		int [] arr3 = arr1;  //얕은 복사 = shallow copy
		
		
		int [] arr4 = new int[arr1.length];  // 깊은 복사 = deep copy
		...
		int [] arr7 = {87,65,82,46,98,65,72,34,91,79,45,67};
		
		String[] grade = new String[arr7.length];
		...
		System.out.println("등급: "+ Arrays.toString(grade));
